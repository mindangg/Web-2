...
const ModalAddSku = ({ show, handleClose, productId, onSkuAdded }) => {
    ...
    const handleSubmitColor = async (e) => {
        ...
        try {
            ...
            const data = await response.json();
            showNotification(`Thêm màu sắc thành công: ${colorFormData.color}`, 'success');
            ...
            >
                <Form noValidate validated={validated} onSubmit={handleSubmit}>
                    <Modal.Header closeButton>
                        <Modal.Title>Thêm phiên bản SKU mới</Modal.Title>
                    </Modal.Header>
                    <Modal.Body>
                        <Row className="mb-3">
                            <Col>
                    ...
                    <Modal.Body>
                        <Form.Group className="mb-3">
                            ...
                            <Form.Control
                                ...
                                placeholder="Nhập tên màu (VD: Đỏ, Xanh, Đen, Trắng...)"
                                required
                            />
                            <Form.Control.Feedback type="invalid">
